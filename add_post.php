...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <form action="con_add_post.php" method="post" enctype="multipart/form-data">
          ...
          <div class="card card-dark">
            <div class="card-header">
              ...
              <div class="card-tools">
                  ...
                  <button type="button" class="btn btn-tool mt-1" data-card-widget="collapse"><i class="fas fa-minus"></i>
                        </button>
              </div>
            </div>
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <textarea id="inputDescription" class="form-control" rows="4" name="postdesc" required></textarea>
                    </div>
                    
                    <div class="form-group">
                        <label for="postfile">Upload File</label>
                        <span class="text-muted">(Only png and jpg allowed)</span>
                        <div>
                        <input type="file" class="" name="postfile" id="postfile">
                        </div>
                    </div>
                    <!-- <div class="form-group">
      ...
      <div class="row">
        <div class="col-12">
          <input type="submit" value="Post" class="btn" style="background:#03599E; color:white;">&nbsp;
